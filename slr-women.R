...
cor(women)
ls(women)
cov(women$height, women$weight) #gives direction of relation. if +ve then increases
cor(women$height, women$weight) #gives how much does one increase as the other one also increases
